...
--
-- Name: hour_type; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.hour_type OWNER TO postgres;

--
-- Name: teacher_grade; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.teacher_grade OWNER TO postgres;

--
-- Name: teacher_rank; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.teacher_rank OWNER TO postgres;
...
--
-- Name: equivalence_rates; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.equivalence_rates OWNER TO postgres;

--
-- Name: equivalence_rates_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.equivalence_rates_id_seq OWNER TO postgres;

--
-- Name: equivalence_rates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.hour_entries OWNER TO postgres;

--
-- Name: hour_entries_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.hour_entries_id_seq OWNER TO postgres;

--
-- Name: hour_entries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: hourly_rates_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.hourly_rates_id_seq OWNER TO postgres;

--
-- Name: hourly_rates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.ues (
    ...
    academic_year_id integer,
    created_at timestamp without time zone DEFAULT now(),
    CONSTRAINT chk_level CHECK (((level)::text = ANY ((ARRAY['L1'::character varying, 'L2'::character varying, 'L3'::character varying, 'M1'::character varying, 'M2'::character varying])::text[])))
);
...
ALTER SEQUENCE public.programs_id_seq OWNED BY public.ues.id;
...
--
-- Name: v_teacher_balance; Type: VIEW; Schema: public; Owner: postgres
--
 ...
 SELECT t.id AS teacher_id,
    ...
    sum(
        CASE
            ...
            ELSE (0)::numeric
        END) AS tp_raw,
    sum(COALESCE(h.etd_hours, (0)::numeric)) AS total_etd,
    GREATEST((0)::numeric, (sum(COALESCE(h.etd_hours, (0)::numeric)) - t.contractual_hours)) AS complementary_etd,
    LEAST(sum(COALESCE(h.etd_hours, (0)::numeric)), t.contractual_hours) AS normal_etd
   FROM ((((public.teachers t
     JOIN public.users u ON ((u.id = t.user_id)))
     LEFT JOIN public.departments d ON ((d.id = t.department_id)))
     CROSS JOIN public.academic_years ay)
     LEFT JOIN public.hour_entries h ON (((h.teacher_id = t.id) AND (h.academic_year_id = ay.id))))
  GROUP BY t.id, u.first_name, u.last_name, t.grade, t.rank, t.status, t.contractual_hours, d.name, ay.label, ay.id;


ALTER TABLE public.v_teacher_balance OWNER TO postgres;

--
-- Name: v_accounting; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER TABLE public.v_accounting OWNER TO postgres;
...
--
-- Name: equivalence_rates id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: hourly_rates id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: ues id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ues ALTER COLUMN id SET DEFAULT nextval('public.programs_id_seq'::regclass);
...
--
-- Name: equivalence_rates equivalence_rates_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: equivalence_rates equivalence_rates_type_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries hour_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ues programs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hourly_rates unique_grade_status; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: academic_years unique_label; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_hour_entries_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_hour_entries_month_year; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_hour_entries_teacher; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_hour_entries_type; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_hour_entries_year; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_programs_department; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_subjects_program; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_teachers_department; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_teachers_grade; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_teachers_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries hour_entries_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries hour_entries_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries hour_entries_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries hour_entries_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hour_entries hour_entries_validated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ues programs_academic_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ues programs_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: subjects subjects_program_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
