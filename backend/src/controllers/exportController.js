...
import { getTeacherById, getTeacherAccounting } from "../models/teacherModel.js";
...
export const exportAccountingExcel = async (req, res) => {
  try {
    ...
    ws.addRow(['Nom','Prénom','Grade','Statut','Département','CM (h)','TD (h)','TP (h)','Total ETD','Service','Complémentaires','Taux (FCFA)','Montant Dû (FCFA)']);
    ...
    // Colonnes
    ws.columns = [
      {key:'last_name',width:15},{key:'first_name',width:15},{key:'grade',width:18},
